	...
	return (
		<div className='w-full h-full bg-gray-900'>
			...
			>
				...
				<MiniMap
					nodeColor={(node) =>
						nodeColors[(node.data as StoryNodeData).type] || '#64748b'
					}
				...
				<Panel position='top-left' className='flex flex-col gap-2'>
					...
					<button
						onClick={() => navigate('/')}
						className='px-4 py-2 bg-gray-800 text-white rounded-lg border border-gray-600 hover:bg-gray-700 flex items-center gap-2'
					>
						← {isVi ? 'Về Menu' : 'Back to Menu'}
					</button>

					{/* Title */}
					<div className='bg-gray-800/90 backdrop-blur px-4 py-2 rounded-lg border border-gray-600'>
					...
					<div className='flex flex-wrap gap-1'>
						...
						>
							📐 {isVi ? 'Auto Layout' : 'Auto Layout'}
						</button>
					</div>

					{/* Legend */}
					<div className='bg-gray-800/90 backdrop-blur p-3 rounded-lg border border-gray-600'>
				...
				{selectedNode && (
					<Panel position='top-right' className='max-w-sm'>
						<div className='bg-gray-800/95 backdrop-blur p-4 rounded-lg border border-gray-600'>
